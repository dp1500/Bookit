...
# ////////////// SENDING ADMIN ASKED PDF REPORT OF THE DASHBOARD ////////////////////
...
def generate_pdf():
    ...
    print("pdf from dashboard generotor activated")
    ...
    # Save the PDF to a file
    pdf_file = f"{username}_report.pdf"
    with open(pdf_file, "wb") as file:
        file.write(pdf)
    ...
    send_email(
        ...
        subject="Theatre Stats and Growth",
        message="Please find attached your Theatre Stats and Growth report.",
        content="text",
        attachment_file=pdf_file
    )
    ...
    return jsonify({"msg": "Report generation started."}), 200
